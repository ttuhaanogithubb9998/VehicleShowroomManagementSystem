...
namespace VehicleShowroomManagementSystem.Areas.Admin.Controllers
{
    ...
    public class BranchesController : CheckAdminController
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Location,Name,PhoneNumber,Address,Status")] Branch branch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Location,Name,PhoneNumber,Address,Status")] Branch branch)
        {
            if (id != branch.Id)
            {
                return NotFound();
