...
namespace VehicleShowroomManagementSystem.Areas.Admin.Controllers
{
    ...
    public class InvoicesController : Controller
    {
        ...
        {
            ViewData["CustomerId"] = new SelectList(_context.Customers, "Id", "Account");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerId,Date,ContractNumber,Description,ShippingAddress,ShippingPhone,TotalPrice,Status")] Invoice invoice)
        {
            ...
            ViewData["CustomerId"] = new SelectList(_context.Customers, "Id", "Account", invoice.CustomerId);
            return View(invoice);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerId,Date,ContractNumber,Description,ShippingAddress,ShippingPhone,TotalPrice,Status")] Invoice invoice)
        {
            if (id != invoice.Id)
            {
                return NotFound();
